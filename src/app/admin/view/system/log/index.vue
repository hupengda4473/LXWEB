...
import {tableSearch} from "@/packages/utils/utils.ts"
import { tableSetting, btnConfig } from '@/app/admin/config/config.js'
import {findAllLog} from "@/app/admin/api/log"
...
const compHandle = reactive({
    ...
    search() {
        ...
        let searchItem = ['RoleName']
        compData.tableData = tableSearch(keyword, searchItem, compData.allData)
    },
    exportData() {
