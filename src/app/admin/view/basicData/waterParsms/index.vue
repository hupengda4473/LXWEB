...
import {DeleteParam, ListParams} from "@/app/admin/api/waterQuality"
...
const compHandle = reactive({
    ...
    dels() {
        ...
        deleteModalRef.value.openDeleteModal('确认要删除所选参数吗？',function deleteFun() {
            deleteItem(ids)
    ...
    exportData() {
        ExportTable(compData.allData, compData.columns, '水质参数')
    },
})
