...
import {PaymentStatistics} from "@/app/admin/api/waterFeeCollection"
...
const compHandle = reactive({
    ...
    getTableData() {
        ...
        PaymentStatistics( year ).then((res) => {
            let data = res.data
            compData.allData = data || []
            let props = ['Year', 'AssociationName', 'PayableAmount', 'TotalWater', 'PlantArea', 'PaidAmount', 'SurplusAmount']
    ...
    exportData() {
        ExportTable(compData.allData, compData.columns, '缴费统计')
    },
})
