...
import {btnConfig, requestUrl} from '@/app/admin/config/config.js'
import {renderIcon} from '@/packages/config/icon.ts'
import {Search} from "@/app/admin/untils/FuzzySearch"
import {createViewColumns} from "@/app/admin/view/waterRight/organization/data"
...
const compHandle = reactive({
    ...
    search() {
        let props = ['HolderName', 'Code', 'FetchWaterAddress', 'FetchWaterType', 'FetchWaterQuantity']
...
const initTable = () => {
    compData.sourceColumns = createViewColumns({compHandle})
